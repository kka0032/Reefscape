...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    // NOTE: all following configs are probably not something you care about, if
    // they cause issues stub 'em all out
  ...
  public static final class ElevatorPositions {
    ...
    // NOTE: this is a pretty clever way to repeatably command the elevator to set
  ...
  public static final class ClimberConstants {
    ...
    private static final Slot0Configs CLIMBER_MOTOR_GAINS = new Slot0Configs()
        ...
        .withKS(0.1103).withKV(0.92196).withKA(0.0019); // Friction, velocity, and acceleration feedforward gains
    // .withKG(0.5609).withGravityType(GravityTypeValue.Climber_Static); // Gravity
    // compensation gains
